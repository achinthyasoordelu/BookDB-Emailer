...
def getQuotesFromDB():
    ...
    randomQuoteIDs = [random.randrange(1, recordCount + 1) for i in range(5)] #TODO generate 5 random numbers from previous seed (last 5 numbers)/increase randomness if possible
    quotes = []
